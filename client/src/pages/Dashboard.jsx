			...
			{loading ? (
				...
				<>
					<div className="container mx-auto text-center mt-10 mb-10">
						<div className="container mx-auto text-center">
							...
							<div className="container mx-auto text-center mt-10">
								<div
									className="card ml-10 mr-10 shadow-xl"
									style={{
								...
								>
									<div className="container mx-auto overflow-auto m-8 ml-2 mr-2">
										<table
					...
					<div className="container mx-auto text-center mt-20 mb-20">
						...
						>
							<div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 ml-6 mr-6 mb-3 mt-3">
								{teams.map((team, index) => {
							...
							<ReactPaginate
								...
								nextLabel={"Next"}
								containerClassName={"btn-group mx-auto mt-10 mb-5"}
								pageClassName={"btn"}
